<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div class="d-flex flex-column flex-xl-row">
                    ...
                    <div class="mb-5 card mb-xl-8">
                        ...
                        <div class="card-body pt-15">
                            ...
                            <div class="mb-5 d-flex flex-center flex-column">
                                ...
                                <div class="mb-1 text-gray-800 fs-3 text-hover-primary fw-bold">
                                ...
                                <!--end::Name-->
                                <!--begin::Position-->
                                <div class="mb-6 fs-5 fw-semibold text-muted">{{ $loan->user->occupation }}</div>
                                <!--end::Position-->
                                <!--begin::Info-->
                                <div class="flex-wrap d-flex flex-center">
                                    ...
                                    <div class="row justify-content-center">
                                        <div
                                            class="px-3 py-3 m-3 mx-4 border border-gray-300 border-dashed rounded col-lg-4">
                            ...
                            <div id="kt_customer_view_details" class="collapse show">
                                <div class="py-5 fs-6">
                                    <div class="mt-5 fw-bold">Account ID</div>
                                    <div class="text-gray-600">ID-{{$loan->user->id}} </div>
                                    <div class="mt-5 fw-bold">Gender</div>
                                    ...
                                    <div class="mt-5 fw-bold">Interest Rate</div>
                ...
                <div class="flex-lg-row-fluid ms-lg-15">
                    <div class="float-end">
                        ...
                        <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-250px fs-6" data-kt-menu="true">
                                {{-- <div class="px-5 menu-item">
                                    <div class="px-5 pb-2 menu-content text-muted fs-7 text-uppercase">Payments</div>
                                </div> --}}
                                <div class="px-5 menu-item">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_decline_warning" wire:click="setLoanID({{$loan->id}})" class="px-5 menu-link"> Decline </a>
                                </div>
                                <div class="px-5 menu-item">
                                    <a href="#" wire:click="accept({{$loan->id}})" class="px-5 menu-link"> Approve </a>
                                </div>
                        </div>
                    </div>
                    ...
                    <ul class="mb-8 border-0 nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x fs-4 fw-semibold">
                        ...
                        <li class="nav-item">
                            <a wire:click="ai_score()" class="pb-4 nav-link text-active-primary" data-bs-toggle="tab"
                        ...
                        <li class="nav-item">
                            <a class="pb-4 nav-link text-active-primary" data-kt-countup-tabs="true"
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="kt_credit_assement_tab"
                            role="tabpanel">
                            <div class="pt-4 mb-6 card mb-xl-9">
                                <div id="kt_customer_view_payment_method" class="pt-0 card-body">
                                    {{-- <div class="py-0" data-kt-customer-payment-method="row">
                                        ...
                                        <div class="alert alert-danger">
                                            <div class="d-flex">
                                                ...
                                                <p class="col-10">
                                                    ...
                                                    <br/>
                                                    {{ $loan_ai['message'] }} 
                                                    Please make sure you have updated your Basic and Net Pay for the Customer
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <table class="table table-flush fw-semibold gy-1">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-gray-800">
                                                                        <small class="mt-2 text-white d-block fw-bold">
                                                                            @if($loan->complete == 1)
                                                                                <small class="p-2 text-white rounded bg-success">{{ 'Completed' }}</small>
                                                                            @else
                                                                                <small class="p-2 text-white rounded bg-danger">{{ 'Incomplete' }}</small>
                                                                            @endif
                                                                        </small>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                                    <td class="text-gray-800">
                                                                        <small class="mt-2 text-dark d-block fw-bold">
                        ...
                        <div class="tab-pane fade" id="kt_customer_view_documents" role="tabpanel">
                            ...
                            <div class="pt-4 mb-6 card mb-xl-9">
                                ...
                                <div class="py-0 card-body">
                                    <div class="mb-6 row g-6 g-xl-9 mb-xl-9">
                                        <div class="row">
                                            <div class="row col-6">
    ...
    <script>
        ...
        window.onload = function() {
            ...
            var dueAmount = parseFloat(@json(array_sum(array_column($amortization_table, 'payment'))));
            // Show plp rule
