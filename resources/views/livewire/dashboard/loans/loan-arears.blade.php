                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold fs-3 mb-1">Loan Arears</span>
                            <span class="text-muted mt-1 fw-semibold fs-7">Over {{$loan_requests->count()}} Loan Arears</span>
                        </h3>
                        <div>
                                ...
                                <div class="alert alert-dark alert-dismissible fade show">
                                    ...
                                    <div class="media">
                                        <div class="media-body">
                                            <small class="mb-0">
                                                Loans that are overdue but have not missed a repayment.
                                                Once a loan becomes overdue, it will be marked as Missed Repayment status.
                                                If a part-payment has been received for last collection date and loan is overdue and not expired, it will be converted into Arrears status.                                            </small>
                                        </div>
                                    </div>
                                </div>
                            </div>
