            ...
            <div class="aside-user-info flex-row-fluid flex-wrap ms-5">
                ...
                <div class="d-flex">
                    ...
                    <div class="flex-grow-1 me-2">
                        <!--begin::Username-->
                        <a href="#" class="text-white text-hover-primary fs-6 fw-bold">Vwanganji Bowa</a>
                        <!--end::Username-->
                        <!--begin::Description-->
                        <span class="text-warning fw-semibold d-block fs-8 mb-1">Director</span>
                        <!--end::Description-->
                        <!--begin::Label-->
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="fw-bold d-flex align-items-center fs-5">Vwanganji Bowa
                                            <span
                                                class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Admin</span>
                                        </div>
                                        <a href="#"
                                            class="fw-semibold text-muted text-hover-primary fs-7">cbowa@mightyfinance.co.zm</a>
                                    </div>
                                    <!--end::Username-->
                                </div>
                            </div>
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link" href="pages/borrowers/manage_borrowers.php">
                ...
                <div class="menu-item">
                    ...
                    <a class="menu-link" href="https://preview.keenthemes.com/metronic8/demo8/layout-builder.html">
                        ...
                        <span class="menu-title">Website Builder</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
